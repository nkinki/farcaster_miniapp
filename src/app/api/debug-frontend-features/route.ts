  ...
  try {
    ...
    return NextResponse.json({
      ...
      environment: {
        ...
        NEXT_PUBLIC_ENABLE_ENHANCED_PROMOTIONS: process.env.NEXT_PUBLIC_ENABLE_ENHANCED_PROMOTIONS,
        ENABLE_COMMENT_ANALYTICS: process.env.ENABLE_COMMENT_ANALYTICS,
        NEXT_PUBLIC_ENABLE_COMMENT_ANALYTICS: process.env.NEXT_PUBLIC_ENABLE_COMMENT_ANALYTICS,
        DEBUG_MODE: process.env.DEBUG_MODE,
        NEXT_PUBLIC_DEBUG_MODE: process.env.NEXT_PUBLIC_DEBUG_MODE,
      },
      computed: {
        ENABLE_COMMENTS: FEATURES.ENABLE_COMMENTS,
        ENABLE_ENHANCED_PROMOTIONS: FEATURES.ENABLE_ENHANCED_PROMOTIONS,
        ENABLE_COMMENT_ANALYTICS: FEATURES.ENABLE_COMMENT_ANALYTICS,
