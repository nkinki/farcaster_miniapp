...
export async function POST(request: NextRequest) {
  try {
    ...
    // 2. Ha nincs elég allowance, approve-oljuk
    if (currentAllowance < amountInWei) {
      ...
      // Várjuk meg a tranzakció megerősítését
    ...
    // 3. Most a szerződés tudja használni a token-eket
    // Itt hívhatnánk a claim funkciót, de most csak visszaadjuk az approve státuszt
