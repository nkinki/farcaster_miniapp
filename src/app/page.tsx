...
export default function Home() {
  ...
  function getMiniappWarpcastLink(app: Miniapp) {
    if (app.homeUrl.includes('warpcast.com/~/developers/miniapps')) return app.homeUrl;
    // Ha a homeUrl nem warpcast link, generáljuk a domain alapján
    return `https://warpcast.com/~/developers/miniapps/${app.domain}`;
  }
        ...
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/70">
          <div className="bg-[#181c23] rounded-2xl shadow-2xl p-4 max-w-3xl w-full flex flex-col items-center relative">
            ...
            <div className="w-full h-[70vh] flex items-center justify-center bg-black rounded-xl overflow-hidden">
              <iframe src={getMiniappWarpcastLink(sortedMiniapps[openMiniappIdx])} title="Miniapp preview" className="w-full h-full border-0" />
            </div>
