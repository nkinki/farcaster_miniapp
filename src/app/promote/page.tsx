...
export default function PromotePage() {
  ...
  const availablePromos = allPromotions.filter(p => {
    ...
    if (promotionFilter !== 'all') {
      const promoActionType = p.actionType || 'quote'; // Use typed actionType field
      console.log(`🔍 Filtering promotion ${p.id}: actionType=${promoActionType}, filter=${promotionFilter}`);
  ...
  console.log(`🔍 Available promotions after filtering:`, availablePromos.length);
  console.log(`🔍 Current filter:`, promotionFilter);
  console.log(`🔍 All promotions:`, allPromotions.map(p => ({ id: p.id, actionType: p.actionType, status: p.status })));
