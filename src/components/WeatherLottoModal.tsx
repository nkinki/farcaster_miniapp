                      ...
                      <div className="text-center">
                        ...
                        <div className="mt-2 pt-2 border-t border-orange-200">
                          <div className="text-sm text-green-600 font-semibold">
                            Win: {currentRound && currentRound.sunny_tickets > 0 ? formatNumber(Number(TICKET_PRICE) * 0.7) : '0'} CHESS
                          </div>
                          <div className="text-sm text-orange-600">
                            ROI: {currentRound && currentRound.sunny_tickets > 0 ? '-30.0' : '0'}%
                          </div>
                        </div>
                      </div>
                  </button>
                  ...
                  >
                      <div className="text-center">
                        ...
                        <div className="mt-2 pt-2 border-t border-blue-200">
                          <div className="text-sm text-green-600 font-semibold">
                            Win: {currentRound && currentRound.rainy_tickets > 0 ? formatNumber(Number(TICKET_PRICE) * 0.7) : '0'} CHESS
                          </div>
                          <div className="text-sm text-blue-600">
                            ROI: {currentRound && currentRound.rainy_tickets > 0 ? '-30.0' : '0'}%
                          </div>
                        </div>
                      </div>
                  </button>
                    ...
                    <div className="pt-1 border-t border-gray-200">
                      <div className="text-center">
                        <div className="text-xs text-gray-600 mb-1">
                          Win with {quantity} ticket{quantity > 1 ? 's' : ''}: {formatNumber(Number(TICKET_PRICE) * 0.7 * quantity)} CHESS
                        </div>
