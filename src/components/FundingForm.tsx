...
// FIX: We import directly from ABI files for maximum clarity.
import { CHESS_TOKEN_ADDRESS, CHESS_TOKEN_ABI } from "@/abis/chessToken";
import { PROMO_CONTRACT_ADDRESS, PROMO_CONTRACT_ABI } from "@/abis/farcasterPromo"; // Assuming the old promo ABI is here.
...
export default function FundingForm({ promotionId, onSuccess, onCancel }: FundingFormProps) {
  ...
  const [amount, setAmount] = useState('10000'); // Default funding amount
