          ...
          {loading ? (
            ...
            <div className="relative z-10 flex-1 overflow-y-auto space-y-6">
              <div className="bg-[#23283a] rounded-xl p-4 border border-[#a64d79] pulse-glow">
                ...
                {/* 10x10 Grid - Garantált 10 oszlop CSS Grid-del */}
                <div className="mb-4 flex justify-center">
                  <div className="border-2 border-purple-500/30 rounded-xl shadow-[0_0_20px_rgba(168,85,247,0.4)] bg-gradient-to-br from-purple-900/10 to-transparent pulse-glow p-4 w-fit">
                    <div className="grid grid-cols-10 gap-2">
                      {Array.from({ length: 100 }, (_, i) => i + 1).map((number) => (
                        <button 
                          ...
                          className={`w-9 h-9 rounded text-sm font-bold transition-all duration-200 border-2 flex items-center justify-center ${
