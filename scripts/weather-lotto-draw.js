...
if (require.main === module) {
  performWeatherLottoDraw()
    .then(() => {
      console.log('🎯 Weather Lotto draw script completed.');
      process.exit(0);
    })
    .catch((error) => {
      console.error('💥 Weather Lotto draw script failed:', error);
      process.exit(1);
    });
}

module.exports = { performWeatherLottoDraw };
